...
public class MainMenu extends JFrame implements ViewConstants {
	...
	/**
	 * Returns the text entered in the username field, as a String
	...
	/**
	 * Returns the text entered in the password field, as a String
	...
	/**
	 * Sets the text in the username field to an empty String
	 */
	...
	/**
	 * Sets the text in the password field to an empty String
	 */
